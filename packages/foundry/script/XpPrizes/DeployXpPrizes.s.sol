...
contract DeployXpPrizes is Script {
    address prizeToken = block.chainid == 11155111 ? 0x32D7E390bE97b4a42d6fB77f0f2DC3D158076295  // Sepolia test token
        : 0x62B8B11039FcfE5aB0C56E502b1C372A3d2a9c7A;  // GoodDollar: 0x62B8B11039FcfE5aB0C56E502b1C372A3d2a9c7A / test token: 0x3fb563125C655D5d37026980313518Ed545FE3a1
    ...
    function run() external returns (address) {
        ...
        if (prizeToken == 0x62B8B11039FcfE5aB0C56E502b1C372A3d2a9c7A) {
            uint256 totalPrizeAmount = XpPrizes(payable(xpPrizes)).totalPrizeAmount();
            MockToken(prizeToken).approve(xpPrizes, totalPrizeAmount);
            MockToken(prizeToken).transfer(xpPrizes, totalPrizeAmount);
        }
        vm.stopBroadcast();
