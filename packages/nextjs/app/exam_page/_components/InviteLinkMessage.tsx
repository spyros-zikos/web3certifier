...
const InviteLinkMessage = ({ id, address }: { id: bigint, address: string }) => {
    ...
    return (
        <Box fontSize="sm" mt="8" border="2px" borderStyle="solid" borderColor="lightGreen" rounded="lg" p="4" bg="green.50">
            ...
            <Box mb="3">Share this exam and earn rewards for every participant who submits (for the first time) using your referral link! Users that use your invite link to submit answers for the first time will also receive 2,000 G$ tokens!</Box>
