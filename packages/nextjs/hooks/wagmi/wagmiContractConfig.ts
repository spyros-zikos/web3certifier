...
export const wagmiContractConfig: (chainId: number|undefined) => config = (chainId: number|undefined) => {
    return {
        address: chainId == 11155111 ? process.env.NEXT_PUBLIC_SEPOLIA_PROXY_ADDRESS! :
                 chainId == 42161 ? process.env.NEXT_PUBLIC_ARBITRUM_PROXY_ADDRESS! :
                 process.env.NEXT_PUBLIC_CELO_PROXY_ADDRESS!,
        abi: [
            {
                "inputs": [],
